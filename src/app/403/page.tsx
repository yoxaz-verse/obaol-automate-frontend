...
export default function ForbiddenPage() {
  return (
    <main className="min-h-screen bg-background text-foreground grid place-items-center p-6">
      <section className="w-full max-w-xl rounded-3xl border border-obaol-500/20 bg-content1 p-8 text-center shadow-xl">
        <p className="text-xs font-black uppercase tracking-[0.25em] text-obaol-600">Access restricted</p>
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3">
          <Link href="/dashboard" className="rounded-xl bg-obaol-500 px-5 py-3 text-sm font-bold text-black">
            Return to dashboard
          </Link>
