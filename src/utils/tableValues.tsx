...
export const generateColumns = (currentTable: string, tableConfig: any, userRole?: string) => {
  ...
  if (currentTable === "associateCompany") {
    ...
    nonActionColumns.push({ name: "Type", uid: "classification", maxWidth: "max-w-[240px]" });
...
> = {
  ...
  product: [
    ...
    },
    {
      ...
      inTable: false,
      required: true,
      showWhen: { key: "isOrganic", equals: [true] },
    },
    {
      label: "Organic Certification Body (Other)",
      type: "text",
      key: "organicCertificationBodyOther",
      inForm: true,
      inEdit: true,
      inTable: false,
      required: true,
      showWhen: { key: "organicCertificationBody", equals: ["OTHER"] },
    },
    {
      label: "Organic Certificate Number",
      type: "text",
      key: "organicCertificateNumber",
      inForm: true,
      inEdit: true,
      inTable: false,
      required: true,
    ...
    {
      label: "Organic Certificate Valid From",
      type: "date",
      key: "organicCertificateValidFrom",
      inForm: true,
      inEdit: true,
      inTable: false,
      required: true,
    ...
    {
      label: "Organic Certificate Valid To",
      type: "date",
      key: "organicCertificateValidTo",
      inForm: true,
      inEdit: true,
      inTable: false,
      required: true,
    ...
    {
      label: "Organic Certified Quantity",
      type: "number",
      key: "organicCertifiedQuantity",
      inForm: true,
      inEdit: true,
      inTable: false,
      required: true,
    ...
    {
      label: "Organic Certified Quantity Unit",
      type: "select",
      key: "organicCertifiedQuantityUnit",
      values: [
        { key: "KG", value: "KG" },
    ...
    {
      label: "Organic Certification Scope",
      type: "select",
      key: "organicCertificationScope",
      values: [
    ...
    {
      label: "Organic Certificate Document URL",
      type: "text",
      key: "organicCertificateDocumentUrl",
      inForm: true,
      inEdit: true,
      inTable: false,
      showWhen: { key: "isOrganic", equals: [true] },
    ...
    },
    {
      ...
      inTable: false,
      required: true,
      showWhen: { key: "isGiTagged", equals: [true] },
    },
    {
      label: "GI Certificate Number",
      type: "text",
      key: "giCertificateNumber",
      inForm: true,
      inEdit: true,
      inTable: false,
      required: true,
