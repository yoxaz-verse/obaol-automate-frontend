  ...
  return (
    <Card className='flex flex-col p-5'>
      <div className='flex justify-between w-full items-center pb-4'>
        <div className='text-[#3EADEB] text-lg font-medium'>{data.title ?? "Title"}</div>
        <div><FiEdit /></div>
      </div>
      <div>
        ...
        <div className='flex'>
          ...
          <div className='flex flex-col px-2'>
            <div className='font-medium'>{data?.customerId?.name ?? "Customer Name"}</div>
            <div className='text-[#A1A1AA] text-sm'>Customer</div>
          </div>
        </div>
        <div className='text-[#A1A1AA] text-sm pt-4 pb-8'>{data.description ?? "Description"}</div>
          ...
          <Card className='w-[230px] pb-1'>
            ...
            <div className='flex flex-row pl-2'>
              ...
              <div className='flex flex-col pl-5'>
                <div className='font-medium'>{data?.managerId?.name ?? "Manager Name"}</div>
