...
export default function HomeLegacyHeader() {
          ...
          >
            <Link href="/" className="relative flex items-center gap-2.5 group flex-shrink-0">
              <Image
                ...
                height={26}
                priority
                className="object-contain rounded-md transition-opacity duration-300 group-hover:opacity-80 md:w-[100px]"
              />
            ...
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <button
                ...
                className="group relative inline-flex items-center gap-1.5 px-3 py-1.5 md:px-4 md:py-2 rounded-xl text-xs md:text-sm font-semibold overflow-hidden transition-all duration-300 bg-orange-500 hover:bg-orange-600 text-white shadow-none hover:scale-[1.03] active:scale-[0.97] disabled:opacity-80 disabled:scale-100"
              >
                ...
                {!isNavigating && (
                  <svg className="relative w-3 h-3 md:w-3.5 md:h-3.5 group-hover:translate-x-0.5 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
