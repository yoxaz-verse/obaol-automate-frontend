...
export default function AboutSection() {
    return (
        <section className="py-24 px-6 bg-background border-t border-default-200" id="about">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    <p className="text-default-500 text-lg leading-relaxed mb-6">
                    ...
                    <div className="flex flex-col gap-4">
                        <div>
                            <h3 className="text-foreground font-medium text-xl">The Founder</h3>
                ...
                {/* IMAGE / VISUAL */}
                <div className="relative h-96 w-full rounded-2xl overflow-hidden bg-content2 border border-default-200 flex items-center justify-center">
                    <ParticleNetwork />
                </div>
            </div>
        </section>
