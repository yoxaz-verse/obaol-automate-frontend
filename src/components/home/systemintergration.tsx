...
const scale = useTransform(
  ...
  return (
     ...
     <motion.section 
       ...
       }}   className="relative py-28 px-6 border-t border-gray-800 bg-neutral-950 overflow-hidden">
          ...
          >
            ...
            >
              <motion.div
                ...
                className="p-8 rounded-xl border border-gray-800 bg-black relative overflow-hidden"
              >
